...
def form_dist_salary(list_dist_salary, step_salary):
    ...
    config.plt.savefig('dist_salary.png')
...
def doParse(title, area):
    ...
    values_stats = form_dist_salary(list_dist_salary=list_dist_salary, step_salary=config.STEP_VALUE)
